...
class ArticleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Article entity")
        ...
        .repeat(2) {
            ...
            .post("/api/articles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "content":"SAMPLE_TEXT", "permalink":"SAMPLE_TEXT", "creationDate":"2020-01-01T00:00:00.000Z", "lastUpdateDate":"2020-01-01T00:00:00.000Z", "isPublished":null, "enablePublicPreview":null, "author":"SAMPLE_TEXT", "thumbnail":null}""")).asJSON
            .check(status.is(201))
